...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,231 | 🐛 105 | 📅 2026-08-18 list thing.*
...
* [graphql-kotlin](https://github.com/ExpediaDotCom/graphql-kotlin) ⭐ 1,802 | 🐛 83 | 🌐 Kotlin | 📅 2026-08-20: Code-only GraphQL schema generation for Kotlin
...
* [SmallRye GraphQL](https://github.com/smallrye/smallrye-graphql) ⭐ 176 | 🐛 156 | 🌐 Java | 📅 2026-08-20: An implementation of the above mentioned Specification used in [Quarkus](https://quarkus.io/blog/quarkus-1-5-final-released/) and [OpenLiberty](https://openliberty.io/blog/2020/06/05/graphql-open-liberty-20006.html)
...
* [graphql-java-servlet](https://github.com/graphql-java/graphql-java-servlet) ⭐ 228 | 🐛 24 | 🌐 Java | 📅 2026-08-20: Servlet that automatically exposes a schema dynamically built from GraphQL queries and mutations.

* [micronaut-graphql](https://github.com/micronaut-projects/micronaut-graphql) ⭐ 88 | 🐛 25 | 🌐 Java | 📅 2026-08-20: Provides Micronaut GraphQL integration.
...
* [dropwizard-graphql](https://github.com/smoketurner/dropwizard-graphql) ⚠️ Archived - [Dropwizard](http://dropwizard.io) bundle for exposing a GraphQL endpoint (uses [graphql-java-servlet](https://github.com/graphql-java/graphql-java-servlet) ⭐ 228 | 🐛 24 | 🌐 Java | 📅 2026-08-20 internally)
...
* [java-dataloader](https://github.com/graphql-java/java-dataloader) ⭐ 524 | 🐛 24 | 🌐 Java | 📅 2026-08-20: A pure java 8 port of [Facebook DataLoader](https://github.com/facebook/dataloader) ⭐ 13,381 | 🐛 44 | 🌐 JavaScript | 📅 2026-08-11
...
* [JS GraphQL IntelliJ Plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin) ⭐ 898 | 🐛 157 | 🌐 Java | 📅 2026-08-20: GraphQL language support for WebStorm, IntelliJ IDEA and other IDEs based on the IntelliJ Platform.
