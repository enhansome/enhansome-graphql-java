...
> Libraries and projects related to [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,221 | 🐛 46 | 🌐 Java | 📅 2026-09-21

*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,993 | 🐛 107 | 📅 2026-09-02 list thing.*
...
* [graphql-datetime-sample-app](https://github.com/donbeave/graphql-java-datetime/tree/master/graphql-datetime-sample-app) ⭐ 153 | 🐛 6 | 🌐 Java | 📅 2026-09-24: GraphQL example app with usage of date and time scalars
...
* [graphql-java-tools](https://github.com/graphql-java/graphql-java-tools) ⭐ 824 | 🐛 93 | 🌐 Kotlin | 📅 2026-09-23: A schema-first tool for graphql-java inspired by graphql-tools for JS
...
* [graphql-java-codegen-gradle-plugin](https://github.com/kobylynskyi/graphql-java-codegen/tree/master/plugins/gradle) ⭐ 299 | 🐛 91 | 🌐 Java | 📅 2026-09-24: Gradle plugin for generating JVM languages(Such as Scala,Kotlin,Java) types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools.
...
* [test-graphql-java](https://github.com/vimalrajselvam/test-graphql-java) ⭐ 26 | 🐛 2 | 🌐 Java | 📅 2025-11-13: A simple library to help testing the GraphQL endpoint with schema files using any HTTP Client library.
...
* [SmallRye GraphQL](https://github.com/smallrye/smallrye-graphql) ⭐ 177 | 🐛 143 | 🌐 Java | 📅 2026-09-24: An implementation of the above mentioned Specification used in [Quarkus](https://quarkus.io/blog/quarkus-1-5-final-released/) and [OpenLiberty](https://openliberty.io/blog/2020/06/05/graphql-open-liberty-20006.html)
...
* [MicroProfile GraphQL](https://github.com/eclipse/microprofile-graphql) ⭐ 102 | 🐛 79 | 🌐 Java | 📅 2026-09-24: Open Specification for Code-first Java GraphQL Services.
...
* [graphkool](https://github.com/beyondeye/graphkool) ⭐ 23 | 🐛 1 | 🌐 Kotlin | 📅 2016-12-29: GraphQl-java utilities in kotlin
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 22 | 🌐 Java | 📅 2026-09-24:  An implementation of the [Apollo Federation Specification](https://www.apollographql.com/docs/federation/federation-spec/) for graphql-java
...
* [Netflix DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,395 | 🐛 47 | 🌐 Kotlin | 📅 2026-09-24: A GraphQL server framework for Spring Boot developed by Netflix.
...
* [graphql-java-servlet](https://github.com/graphql-java/graphql-java-servlet) ⭐ 229 | 🐛 24 | 🌐 Java | 📅 2026-09-24: Servlet that automatically exposes a schema dynamically built from GraphQL queries and mutations.

* [micronaut-graphql](https://github.com/micronaut-projects/micronaut-graphql) ⭐ 88 | 🐛 26 | 🌐 Java | 📅 2026-09-24: Provides Micronaut GraphQL integration.
...
* [dropwizard-graphql](https://github.com/smoketurner/dropwizard-graphql) ⚠️ Archived - [Dropwizard](http://dropwizard.io) bundle for exposing a GraphQL endpoint (uses [graphql-java-servlet](https://github.com/graphql-java/graphql-java-servlet) ⭐ 229 | 🐛 24 | 🌐 Java | 📅 2026-09-24 internally)
...
* [Light Java GraphQL](https://github.com/networknt/light-java-graphql) ⭐ 37 | 🐛 10 | 🌐 Java | 📅 2026-09-18: A lightweight, fast microservices framework with all other cross-cutting concerns addressed that is ready to plug in GraphQL schema.
...
* [DGS Extended Formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 7 | 🐛 5 | 🌐 Java | 📅 2026-09-23: A set of Netflix DGS schema directives for common response formatting use cases.

## Batch Loading

* [java-dataloader](https://github.com/graphql-java/java-dataloader) ⭐ 525 | 🐛 25 | 🌐 Java | 📅 2026-08-31: A pure java 8 port of [Facebook DataLoader](https://github.com/facebook/dataloader) ⭐ 13,391 | 🐛 43 | 🌐 JavaScript | 📅 2026-09-16

## Scalars

* [graphql-java-extended-scalars](https://github.com/graphql-java/graphql-java-extended-scalars) ⭐ 290 | 🐛 6 | 🌐 Java | 📅 2026-09-21: A series extended scalars for graphql-java based projects, brought you you by the same team that helps build graphql-java itself

* [graphql-java-datetime](https://github.com/donbeave/graphql-java-datetime) ⭐ 153 | 🐛 6 | 🌐 Java | 📅 2026-09-24: A set of ISO 33601, RFC 3339 compatible date time scalars for GraphQL Java

## Tools

* [JS GraphQL IntelliJ Plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin) ⭐ 898 | 🐛 157 | 🌐 Java | 📅 2026-09-24: GraphQL language support for WebStorm, IntelliJ IDEA and other IDEs based on the IntelliJ Platform.
