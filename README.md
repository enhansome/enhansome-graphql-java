...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,420 | 🐛 105 | 📅 2026-09-02 list thing.*
...
* [graphql-java-annotations](https://github.com/graphql-java/graphql-java-annotations) ⭐ 393 | 🐛 5 | 🌐 Java | 📅 2025-10-03: Annotations-based syntax for GraphQL schema definition.
...
* [SmallRye GraphQL](https://github.com/smallrye/smallrye-graphql) ⭐ 177 | 🐛 138 | 🌐 Java | 📅 2026-09-02: An implementation of the above mentioned Specification used in [Quarkus](https://quarkus.io/blog/quarkus-1-5-final-released/) and [OpenLiberty](https://openliberty.io/blog/2020/06/05/graphql-open-liberty-20006.html)
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 21 | 🌐 Java | 📅 2026-09-01:  An implementation of the [Apollo Federation Specification](https://www.apollographql.com/docs/federation/federation-spec/) for graphql-java
...
* [graphql-java-servlet](https://github.com/graphql-java/graphql-java-servlet) ⭐ 229 | 🐛 23 | 🌐 Java | 📅 2026-09-02: Servlet that automatically exposes a schema dynamically built from GraphQL queries and mutations.

* [micronaut-graphql](https://github.com/micronaut-projects/micronaut-graphql) ⭐ 88 | 🐛 30 | 🌐 Java | 📅 2026-09-02: Provides Micronaut GraphQL integration.
...
* [dropwizard-graphql](https://github.com/smoketurner/dropwizard-graphql) ⚠️ Archived - [Dropwizard](http://dropwizard.io) bundle for exposing a GraphQL endpoint (uses [graphql-java-servlet](https://github.com/graphql-java/graphql-java-servlet) ⭐ 229 | 🐛 23 | 🌐 Java | 📅 2026-09-02 internally)
