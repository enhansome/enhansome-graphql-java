...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,058 | 🐛 100 | 📅 2026-06-30 list thing.*
...
* [graphql-datetime-sample-app](https://github.com/donbeave/graphql-java-datetime/tree/master/graphql-datetime-sample-app) ⭐ 153 | 🐛 3 | 🌐 Java | 📅 2026-08-12: GraphQL example app with usage of date and time scalars
...
* [graphql-java-tools](https://github.com/graphql-java/graphql-java-tools) ⭐ 822 | 🐛 90 | 🌐 Kotlin | 📅 2026-08-02: A schema-first tool for graphql-java inspired by graphql-tools for JS
...
* [graphql-kotlin](https://github.com/ExpediaDotCom/graphql-kotlin) ⭐ 1,801 | 🐛 83 | 🌐 Kotlin | 📅 2026-08-10: Code-only GraphQL schema generation for Kotlin
...
* [SmallRye GraphQL](https://github.com/smallrye/smallrye-graphql) ⭐ 176 | 🐛 148 | 🌐 Java | 📅 2026-08-10: An implementation of the above mentioned Specification used in [Quarkus](https://quarkus.io/blog/quarkus-1-5-final-released/) and [OpenLiberty](https://openliberty.io/blog/2020/06/05/graphql-open-liberty-20006.html)
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 19 | 🌐 Java | 📅 2026-08-11:  An implementation of the [Apollo Federation Specification](https://www.apollographql.com/docs/federation/federation-spec/) for graphql-java
...
* [graphql-java-servlet](https://github.com/graphql-java/graphql-java-servlet) ⭐ 228 | 🐛 24 | 🌐 Java | 📅 2026-08-09: Servlet that automatically exposes a schema dynamically built from GraphQL queries and mutations.

* [micronaut-graphql](https://github.com/micronaut-projects/micronaut-graphql) ⭐ 88 | 🐛 25 | 🌐 Java | 📅 2026-08-12: Provides Micronaut GraphQL integration.
...
* [dropwizard-graphql](https://github.com/smoketurner/dropwizard-graphql) ⚠️ Archived - [Dropwizard](http://dropwizard.io) bundle for exposing a GraphQL endpoint (uses [graphql-java-servlet](https://github.com/graphql-java/graphql-java-servlet) ⭐ 228 | 🐛 24 | 🌐 Java | 📅 2026-08-09 internally)
...
* [graphql-java-extended-scalars](https://github.com/graphql-java/graphql-java-extended-scalars) ⭐ 287 | 🐛 6 | 🌐 Java | 📅 2026-08-10: A series extended scalars for graphql-java based projects, brought you you by the same team that helps build graphql-java itself

* [graphql-java-datetime](https://github.com/donbeave/graphql-java-datetime) ⭐ 153 | 🐛 3 | 🌐 Java | 📅 2026-08-12: A set of ISO 33601, RFC 3339 compatible date time scalars for GraphQL Java

## Tools

* [JS GraphQL IntelliJ Plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin) ⭐ 898 | 🐛 157 | 🌐 Java | 📅 2026-08-12: GraphQL language support for WebStorm, IntelliJ IDEA and other IDEs based on the IntelliJ Platform.
